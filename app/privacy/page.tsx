...
export default function PrivacyPage() {
  return (
    <PublicShell maxWidth="md">
      ...
      <p style={li}>&bull; <strong>Participants and campers (students):</strong> name, grade, school, date of birth, t-shirt size, and — for participants who are <strong>13 or older</strong> — an optional student email. We do <strong>not</strong> collect an email or online account for any child under 13 (including all of our elementary VEX IQ program); for them, all communication and access is handled through a parent/guardian.</p>
