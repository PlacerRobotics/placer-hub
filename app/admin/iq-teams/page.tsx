      ...
      {teams.length === 0 ? (
        ...
        <div style={{ overflowX: 'auto', border: '1px solid var(--color-border)', borderRadius: 10 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: 'var(--color-surface)' }}>
            <thead><tr><th style={th}>Team</th><th style={th}>Coach</th><th style={th}>Students</th><th style={th}>Status</th><th style={th}>Fee</th><th style={th}>Created</th><th style={th}></th></tr></thead>
            <tbody>
              {teams.map((t) => {
